...
官方提供了基于 Rasperry Pi OS 5.10.17-v7l+ 32-bit 的装好了 respeaker 驱动的树莓派系统，推荐使用这种方式来安装 respeaker 驱动。

### 手动安装驱动（不推荐）

这款板子的驱动已经长时间没有维护，所以已经无法保证能够顺利安装到目前最新的树莓派系统上。如果要尝试手动安装，先确保你的树莓使用的 Raspberry Pi 系统是 2018 年或更早的版本。
